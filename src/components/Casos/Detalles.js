            ...
            <Contenido categoria="Editar Caso">
                ...
                <div className="col-xs-12 col-md-2">
                    <div className="nav flex-column nav-pills me-3" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        ...
                        <button className="nav-link mb-2 btn-sm p-2 border border-1" id="v-doctor-tab" data-bs-toggle="pill" data-bs-target="#v-doctor" type="button" role="tab" aria-controls="v-doctor" aria-selected="false" >Doctor</button>
                        <button className="nav-link mb-2 btn-sm p-2 border border-1" id="v-paciente-tab" data-bs-toggle="pill" data-bs-target="#v-paciente" type="button" role="tab" aria-controls="v-paciente" aria-selected="false" >Paciente</button>
